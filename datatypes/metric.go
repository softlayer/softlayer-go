...
type Metric_Tracking_Object struct {
	...
	Type *Metric_Tracking_Object_Type `json:"type,omitempty" xmlrpc:"type"`
}
...
type Metric_Tracking_Object_Bandwidth_Summary struct {
	...
	AllocationAmount *Float64 `json:"allocationAmount,omitempty" xmlrpc:"allocationAmount"`
	...
	AverageDailyUsage *Float64 `json:"averageDailyUsage,omitempty" xmlrpc:"averageDailyUsage"`
	...
	CurrentlyOverAllocationFlag *int `json:"currentlyOverAllocationFlag,omitempty" xmlrpc:"currentlyOverAllocationFlag"`
	...
	OutboundBandwidthAmount *Float64 `json:"outboundBandwidthAmount,omitempty" xmlrpc:"outboundBandwidthAmount"`

	// The amount of bandwidth (measured in gigabytes) of projected usage, using a basic average calculation of daily usage.
	ProjectedBandwidthUsage *Float64 `json:"projectedBandwidthUsage,omitempty" xmlrpc:"projectedBandwidthUsage"`
	...
	ProjectedOverAllocationFlag *int `json:"projectedOverAllocationFlag,omitempty" xmlrpc:"projectedOverAllocationFlag"`
}
...
type Metric_Tracking_Object_Data struct {
	...
	Counter *Float64 `json:"counter,omitempty" xmlrpc:"counter"`

	// The time a data record was stored.
	DateTime *Time `json:"dateTime,omitempty" xmlrpc:"dateTime"`
...
type Metric_Tracking_Object_Data_Network_ContentDelivery_Account struct {
	...
	PopId *int `json:"popId,omitempty" xmlrpc:"popId"`
}
...
type Metric_Tracking_Object_Virtual_Storage_Repository struct {
	...
	Resource *Virtual_Storage_Repository `json:"resource,omitempty" xmlrpc:"resource"`
}
