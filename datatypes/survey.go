...
type Survey struct {
	...
	Questions []Survey_Question `json:"questions,omitempty" xmlrpc:"questions"`

	// The status of the survey
	Status *Survey_Status `json:"status,omitempty" xmlrpc:"status"`

	// The status id of the survey.
	StatusId *int `json:"statusId,omitempty" xmlrpc:"statusId"`

	// The type of survey
	Type *Survey_Type `json:"type,omitempty" xmlrpc:"type"`
...
type Survey_Answer struct {
	...
	AnswerOrder *int `json:"answerOrder,omitempty" xmlrpc:"answerOrder"`

	// A survey answer's Id.
	Id *int `json:"id,omitempty" xmlrpc:"id"`

	// The survey question that this answer belongs to.
	SurveyQuestion *Survey_Question `json:"surveyQuestion,omitempty" xmlrpc:"surveyQuestion"`

	// A survey answer's associated [[SoftLayer_Survey_Question|Survey Question]] Id.
	SurveyQuestionId *int `json:"surveyQuestionId,omitempty" xmlrpc:"surveyQuestionId"`
}
...
type Survey_Question struct {
	...
	AnswerCount *uint `json:"answerCount,omitempty" xmlrpc:"answerCount"`

	// The possible answers for a survey question.
	Answers []Survey_Answer `json:"answers,omitempty" xmlrpc:"answers"`
	...
	MultiAnswer *int `json:"multiAnswer,omitempty" xmlrpc:"multiAnswer"`
	...
	QuestionOrder *int `json:"questionOrder,omitempty" xmlrpc:"questionOrder"`

	// The survey that a question belongs to.
	Survey *Survey `json:"survey,omitempty" xmlrpc:"survey"`

	// A survey question's associated [[SoftLayer_Survey|Survey]] Id.
	SurveyId *int `json:"surveyId,omitempty" xmlrpc:"surveyId"`
}
...
type Survey_Response struct {
	...
	OtherAnswer *string `json:"otherAnswer,omitempty" xmlrpc:"otherAnswer"`

	// The survey answer that this response was to.
	SurveyAnswer *Survey_Answer `json:"surveyAnswer,omitempty" xmlrpc:"surveyAnswer"`

	// The Id of the [[SoftLayer_Survey_Answer|Survey Answer]] that a response was made for.
	SurveyAnswerId *int `json:"surveyAnswerId,omitempty" xmlrpc:"surveyAnswerId"`
}
