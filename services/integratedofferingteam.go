...
func (r IntegratedOfferingTeam_Region) GetRegionLeads() (resp []IntegratedOfferingTeam_Container_Region_Lead, err error) {
	err = r.Session.DoRequest("IntegratedOfferingTeam_Region", "getRegionLeads", nil, &r.Options, &resp)
	return
}
