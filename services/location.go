...
func (r Location) GetAvailableObjectStorageDatacenters() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location", "getAvailableObjectStorageDatacenters", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location) GetBackboneDependents() (resp []datatypes.Network_Backbone_Location_Dependent, err error) {
	err = invokeMethod("SoftLayer_Location", "getBackboneDependents", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location) GetDatacenters() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location", "getDatacenters", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Location) GetDatacentersWithVirtualImageStoreServiceResourceRecord() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location", "getDatacentersWithVirtualImageStoreServiceResourceRecord", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location) GetGroups() (resp []datatypes.Location_Group, err error) {
	err = invokeMethod("SoftLayer_Location", "getGroups", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location) GetHardwareFirewalls() (resp []datatypes.Hardware, err error) {
	err = invokeMethod("SoftLayer_Location", "getHardwareFirewalls", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A location's physical address.
func (r Location) GetLocationAddress() (resp datatypes.Account_Address, err error) {
	err = invokeMethod("SoftLayer_Location", "getLocationAddress", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location) GetLocationReservationMember() (resp datatypes.Location_Reservation_Rack_Member, err error) {
	err = invokeMethod("SoftLayer_Location", "getLocationReservationMember", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The current locations status.
func (r Location) GetLocationStatus() (resp datatypes.Location_Status, err error) {
	err = invokeMethod("SoftLayer_Location", "getLocationStatus", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location) GetNetworkConfigurationAttribute() (resp datatypes.Hardware_Attribute, err error) {
	err = invokeMethod("SoftLayer_Location", "getNetworkConfigurationAttribute", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Location) GetObject() (resp datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location) GetOnlinePptpVpnUserCount() (resp int, err error) {
	err = invokeMethod("SoftLayer_Location", "getOnlinePptpVpnUserCount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location) GetOnlineSslVpnUserCount() (resp int, err error) {
	err = invokeMethod("SoftLayer_Location", "getOnlineSslVpnUserCount", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location) GetPathString() (resp string, err error) {
	err = invokeMethod("SoftLayer_Location", "getPathString", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location) GetPriceGroups() (resp []datatypes.Location_Group, err error) {
	err = invokeMethod("SoftLayer_Location", "getPriceGroups", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location) GetRegions() (resp []datatypes.Location_Region, err error) {
	err = invokeMethod("SoftLayer_Location", "getRegions", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location) GetTimezone() (resp datatypes.Locale_Timezone, err error) {
	err = invokeMethod("SoftLayer_Location", "getTimezone", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location) GetVdrGroup() (resp datatypes.Location_Group_Location_CrossReference, err error) {
	err = invokeMethod("SoftLayer_Location", "getVdrGroup", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve all datacenter locations. SoftLayer's datacenters exist in various cities and each contain one or more server rooms which house network and server infrastructure.
func (r Location) GetViewableDatacenters() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location", "getViewableDatacenters", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location) GetViewablePopsAndDataCenters() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location", "getViewablePopsAndDataCenters", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve all viewable network locations.
func (r Location) GetViewablepointOfPresence() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location", "getViewablepointOfPresence", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve all point of presence locations.
func (r Location) GetpointOfPresence() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location", "getpointOfPresence", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Datacenter) GetActiveItemPresaleEvents() (resp []datatypes.Sales_Presale_Event, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getActiveItemPresaleEvents", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location_Datacenter) GetActivePresaleEvents() (resp []datatypes.Sales_Presale_Event, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getActivePresaleEvents", nil, r.Session, &r.Options, &resp)
	return
}

// Object Storage is only available in select datacenters. This method will return all the datacenters where object storage is available.
func (r Location_Datacenter) GetAvailableObjectStorageDatacenters() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getAvailableObjectStorageDatacenters", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location_Datacenter) GetBackboneDependents() (resp []datatypes.Network_Backbone_Location_Dependent, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getBackboneDependents", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location_Datacenter) GetBackendHardwareRouters() (resp []datatypes.Hardware, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getBackendHardwareRouters", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Datacenter) GetBoundSubnets() (resp []datatypes.Network_Subnet, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getBoundSubnets", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Datacenter) GetBrandCountryRestrictions() (resp []datatypes.Brand_Restriction_Location_CustomerCountry, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getBrandCountryRestrictions", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve all datacenter locations. SoftLayer's datacenters exist in various cities and each contain one or more server rooms which house network and server infrastructure.
func (r Location_Datacenter) GetDatacenters() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getDatacenters", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Location_Datacenter) GetDatacentersWithVirtualImageStoreServiceResourceRecord() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getDatacentersWithVirtualImageStoreServiceResourceRecord", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location_Datacenter) GetFrontendHardwareRouters() (resp []datatypes.Hardware, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getFrontendHardwareRouters", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A location can be a member of 1 or more groups. This will show which groups to which a location belongs.
func (r Location_Datacenter) GetGroups() (resp []datatypes.Location_Group, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getGroups", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location_Datacenter) GetHardwareFirewalls() (resp []datatypes.Hardware, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getHardwareFirewalls", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location_Datacenter) GetHardwareRouters() (resp []datatypes.Hardware, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getHardwareRouters", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A location's physical address.
func (r Location_Datacenter) GetLocationAddress() (resp datatypes.Account_Address, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getLocationAddress", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A location's Dedicated Rack member
func (r Location_Datacenter) GetLocationReservationMember() (resp datatypes.Location_Reservation_Rack_Member, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getLocationReservationMember", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The current locations status.
func (r Location_Datacenter) GetLocationStatus() (resp datatypes.Location_Status, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getLocationStatus", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location_Datacenter) GetNetworkConfigurationAttribute() (resp datatypes.Hardware_Attribute, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getNetworkConfigurationAttribute", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Location_Datacenter) GetObject() (resp datatypes.Location_Datacenter, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The total number of users online using SoftLayer's PPTP VPN service for a location.
func (r Location_Datacenter) GetOnlinePptpVpnUserCount() (resp int, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getOnlinePptpVpnUserCount", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The total number of users online using SoftLayer's SSL VPN service for a location.
func (r Location_Datacenter) GetOnlineSslVpnUserCount() (resp int, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getOnlineSslVpnUserCount", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location_Datacenter) GetPathString() (resp string, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getPathString", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location_Datacenter) GetPresaleEvents() (resp []datatypes.Sales_Presale_Event, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getPresaleEvents", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A location can be a member of 1 or more Price Groups. This will show which groups to which a location belongs.
func (r Location_Datacenter) GetPriceGroups() (resp []datatypes.Location_Group, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getPriceGroups", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Datacenter) GetRegionalGroup() (resp datatypes.Location_Group_Regional, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getRegionalGroup", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location_Datacenter) GetRegionalInternetRegistry() (resp datatypes.Network_Regional_Internet_Registry, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getRegionalInternetRegistry", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A location can be a member of 1 or more regions. This will show which regions to which a location belongs.
func (r Location_Datacenter) GetRegions() (resp []datatypes.Location_Region, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getRegions", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Datacenter) GetRoutableBoundSubnets() (resp []datatypes.Network_Subnet, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getRoutableBoundSubnets", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Datacenter) GetStatisticsGraphImage() (resp []byte, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getStatisticsGraphImage", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location_Datacenter) GetTimezone() (resp datatypes.Locale_Timezone, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getTimezone", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A location can be a member of 1 Bandwidth Pooling Group. This will show which group to which a location belongs.
func (r Location_Datacenter) GetVdrGroup() (resp datatypes.Location_Group_Location_CrossReference, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getVdrGroup", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve all datacenter locations. SoftLayer's datacenters exist in various cities and each contain one or more server rooms which house network and server infrastructure.
func (r Location_Datacenter) GetViewableDatacenters() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getViewableDatacenters", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve all viewable pop and datacenter locations.
func (r Location_Datacenter) GetViewablePopsAndDataCenters() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getViewablePopsAndDataCenters", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve all viewable network locations.
func (r Location_Datacenter) GetViewablepointOfPresence() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getViewablepointOfPresence", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve all point of presence locations.
func (r Location_Datacenter) GetpointOfPresence() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location_Datacenter", "getpointOfPresence", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Group) GetAllObjects() (resp []datatypes.Location_Group, err error) {
	err = invokeMethod("SoftLayer_Location_Group", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Group) GetLocationGroupType() (resp datatypes.Location_Group_Type, err error) {
	err = invokeMethod("SoftLayer_Location_Group", "getLocationGroupType", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The locations in a group.
func (r Location_Group) GetLocations() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location_Group", "getLocations", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Location_Group) GetObject() (resp datatypes.Location_Group, err error) {
	err = invokeMethod("SoftLayer_Location_Group", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Group_Pricing) GetAllObjects() (resp []datatypes.Location_Group, err error) {
	err = invokeMethod("SoftLayer_Location_Group_Pricing", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The type for this location group.
func (r Location_Group_Pricing) GetLocationGroupType() (resp datatypes.Location_Group_Type, err error) {
	err = invokeMethod("SoftLayer_Location_Group_Pricing", "getLocationGroupType", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The locations in a group.
func (r Location_Group_Pricing) GetLocations() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location_Group_Pricing", "getLocations", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Location_Group_Pricing) GetObject() (resp datatypes.Location_Group_Pricing, err error) {
	err = invokeMethod("SoftLayer_Location_Group_Pricing", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Group_Pricing) GetPrices() (resp []datatypes.Product_Item_Price, err error) {
	err = invokeMethod("SoftLayer_Location_Group_Pricing", "getPrices", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Group_Regional) GetAllObjects() (resp []datatypes.Location_Group, err error) {
	err = invokeMethod("SoftLayer_Location_Group_Regional", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The datacenters in a group.
func (r Location_Group_Regional) GetDatacenters() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location_Group_Regional", "getDatacenters", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The type for this location group.
func (r Location_Group_Regional) GetLocationGroupType() (resp datatypes.Location_Group_Type, err error) {
	err = invokeMethod("SoftLayer_Location_Group_Regional", "getLocationGroupType", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The locations in a group.
func (r Location_Group_Regional) GetLocations() (resp []datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location_Group_Regional", "getLocations", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Location_Group_Regional) GetObject() (resp datatypes.Location_Group_Regional, err error) {
	err = invokeMethod("SoftLayer_Location_Group_Regional", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Group_Regional) GetPreferredDatacenter() (resp datatypes.Location_Datacenter, err error) {
	err = invokeMethod("SoftLayer_Location_Group_Regional", "getPreferredDatacenter", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Reservation) GetAccount() (resp datatypes.Account, err error) {
	err = invokeMethod("SoftLayer_Location_Reservation", "getAccount", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Location_Reservation) GetAccountReservations() (resp []datatypes.Location_Reservation, err error) {
	err = invokeMethod("SoftLayer_Location_Reservation", "getAccountReservations", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Reservation) GetAllotment() (resp datatypes.Network_Bandwidth_Version1_Allotment, err error) {
	err = invokeMethod("SoftLayer_Location_Reservation", "getAllotment", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The bandwidth allotment that the reservation belongs to.
func (r Location_Reservation) GetBillingItem() (resp datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Location_Reservation", "getBillingItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Reservation) GetLocation() (resp datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location_Reservation", "getLocation", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Reservation) GetLocationReservationRack() (resp datatypes.Location_Reservation_Rack, err error) {
	err = invokeMethod("SoftLayer_Location_Reservation", "getLocationReservationRack", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Location_Reservation) GetObject() (resp datatypes.Location_Reservation, err error) {
	err = invokeMethod("SoftLayer_Location_Reservation", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Reservation_Rack) GetAllotment() (resp datatypes.Network_Bandwidth_Version1_Allotment, err error) {
	err = invokeMethod("SoftLayer_Location_Reservation_Rack", "getAllotment", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Reservation_Rack) GetChildren() (resp []datatypes.Location_Reservation_Rack_Member, err error) {
	err = invokeMethod("SoftLayer_Location_Reservation_Rack", "getChildren", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location_Reservation_Rack) GetLocation() (resp datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location_Reservation_Rack", "getLocation", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location_Reservation_Rack) GetLocationReservation() (resp datatypes.Location_Reservation, err error) {
	err = invokeMethod("SoftLayer_Location_Reservation_Rack", "getLocationReservation", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Location_Reservation_Rack) GetObject() (resp datatypes.Location_Reservation_Rack, err error) {
	err = invokeMethod("SoftLayer_Location_Reservation_Rack", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Location_Reservation_Rack_Member) GetLocation() (resp datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Location_Reservation_Rack_Member", "getLocation", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Location_Reservation_Rack_Member) GetLocationReservationRack() (resp datatypes.Location_Reservation, err error) {
	err = invokeMethod("SoftLayer_Location_Reservation_Rack_Member", "getLocationReservationRack", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Location_Reservation_Rack_Member) GetObject() (resp datatypes.Location_Reservation_Rack_Member, err error) {
	err = invokeMethod("SoftLayer_Location_Reservation_Rack_Member", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
