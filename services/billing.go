...
func (r Billing_Currency) GetAllObjects() (resp []datatypes.Billing_Currency, err error) {
	err = invokeMethod("SoftLayer_Billing_Currency", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Billing_Currency) GetObject() (resp datatypes.Billing_Currency, err error) {
	err = invokeMethod("SoftLayer_Billing_Currency", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Currency) GetPrice(price *float64, formatOptions *datatypes.Container_Billing_Currency_Format) (resp string, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Currency", "getPrice", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Currency_ExchangeRate) GetAllCurrencyExchangeRates(stringDate *string) (resp []datatypes.Billing_Currency_ExchangeRate, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Currency_ExchangeRate", "getAllCurrencyExchangeRates", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Billing_Currency_ExchangeRate) GetCurrencies() (resp []datatypes.Billing_Currency, err error) {
	err = invokeMethod("SoftLayer_Billing_Currency_ExchangeRate", "getCurrencies", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Currency_ExchangeRate) GetExchangeRate(to *string, from *string, effectiveDate *datatypes.Time) (resp datatypes.Billing_Currency_ExchangeRate, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Currency_ExchangeRate", "getExchangeRate", params, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Currency_ExchangeRate) GetFundingCurrency() (resp datatypes.Billing_Currency, err error) {
	err = invokeMethod("SoftLayer_Billing_Currency_ExchangeRate", "getFundingCurrency", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Currency_ExchangeRate) GetLocalCurrency() (resp datatypes.Billing_Currency, err error) {
	err = invokeMethod("SoftLayer_Billing_Currency_ExchangeRate", "getLocalCurrency", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Billing_Currency_ExchangeRate) GetObject() (resp datatypes.Billing_Currency_ExchangeRate, err error) {
	err = invokeMethod("SoftLayer_Billing_Currency_ExchangeRate", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Currency_ExchangeRate) GetPrice(price *float64, formatOptions *datatypes.Container_Billing_Currency_Format) (resp string, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Currency_ExchangeRate", "getPrice", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Info) GetAccount() (resp datatypes.Account, err error) {
	err = invokeMethod("SoftLayer_Billing_Info", "getAccount", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Info) GetAchInformation() (resp []datatypes.Billing_Info_Ach, err error) {
	err = invokeMethod("SoftLayer_Billing_Info", "getAchInformation", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Info) GetCurrency() (resp datatypes.Billing_Currency, err error) {
	err = invokeMethod("SoftLayer_Billing_Info", "getCurrency", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Info) GetCurrentBillingCycle() (resp datatypes.Billing_Info_Cycle, err error) {
	err = invokeMethod("SoftLayer_Billing_Info", "getCurrentBillingCycle", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The date on which an account was last billed.
func (r Billing_Info) GetLastBillDate() (resp datatypes.Time, err error) {
	err = invokeMethod("SoftLayer_Billing_Info", "getLastBillDate", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Info) GetNextBillDate() (resp datatypes.Time, err error) {
	err = invokeMethod("SoftLayer_Billing_Info", "getNextBillDate", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Info) GetObject() (resp datatypes.Billing_Info, err error) {
	err = invokeMethod("SoftLayer_Billing_Info", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) EmailInvoices(options *datatypes.Container_Billing_Invoice_Email) (err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Invoice", "emailInvoices", params, r.Session, &r.Options, &resp)
	return
}

// Retrieve The account that an invoice belongs to.
func (r Billing_Invoice) GetAccount() (resp datatypes.Account, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getAccount", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve This is the amount of this invoice.
func (r Billing_Invoice) GetAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getAmount", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Invoice) GetBrandAtInvoiceCreation() (resp datatypes.Brand, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getBrandAtInvoiceCreation", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetDetailedPdfGeneratedFlag() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getDetailedPdfGeneratedFlag", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetExcel() (resp []byte, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getExcel", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetInvoiceTopLevelItems() (resp []datatypes.Billing_Invoice_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getInvoiceTopLevelItems", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The total amount of this invoice.
func (r Billing_Invoice) GetInvoiceTotalAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getInvoiceTotalAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetInvoiceTotalOneTimeAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getInvoiceTotalOneTimeAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetInvoiceTotalOneTimeTaxAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getInvoiceTotalOneTimeTaxAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetInvoiceTotalPreTaxAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getInvoiceTotalPreTaxAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetInvoiceTotalRecurringAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getInvoiceTotalRecurringAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetInvoiceTotalRecurringTaxAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getInvoiceTotalRecurringTaxAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetItems() (resp []datatypes.Billing_Invoice_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getItems", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetObject() (resp datatypes.Billing_Invoice, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve This is the total payment made on this invoice.
func (r Billing_Invoice) GetPayment() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getPayment", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetPayments() (resp []datatypes.Billing_Invoice_Receivable_Payment, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getPayments", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetPdf() (resp []byte, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getPdf", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetPdfDetailed() (resp []byte, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getPdfDetailed", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Billing_Invoice) GetPdfDetailedFilename() (resp string, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getPdfDetailedFilename", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetPdfFileSize() (resp int, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getPdfFileSize", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Billing_Invoice) GetPdfFilename() (resp string, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getPdfFilename", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetPreliminaryExcel() (resp []byte, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getPreliminaryExcel", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve a PDF record of a SoftLayer invoice. SoftLayer keeps PDF records of all closed invoices for customer retrieval from the portal and API. You must have a PDF reader installed in order to view these invoice files.
func (r Billing_Invoice) GetPreliminaryPdf() (resp []byte, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getPreliminaryPdf", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetPreliminaryPdfDetailed() (resp []byte, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getPreliminaryPdfDetailed", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve This is the seller's tax registration.
func (r Billing_Invoice) GetSellerRegistration() (resp string, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getSellerRegistration", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetTaxInfo() (resp datatypes.Billing_Invoice_Tax_Info, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getTaxInfo", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetTaxInfoHistory() (resp []datatypes.Billing_Invoice_Tax_Info, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getTaxInfoHistory", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetTaxMessage() (resp string, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getTaxMessage", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice) GetTaxType() (resp datatypes.Billing_Invoice_Tax_Type, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getTaxType", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Billing_Invoice) GetXlsFilename() (resp string, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getXlsFilename", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Billing_Invoice) GetZeroFeeItemCounts() (resp []datatypes.Container_Product_Item_Category_ZeroFee_Count, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice", "getZeroFeeItemCounts", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Item) GetAssociatedChildren() (resp []datatypes.Billing_Invoice_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Item", "getAssociatedChildren", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Item) GetAssociatedInvoiceItem() (resp datatypes.Billing_Invoice_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Item", "getAssociatedInvoiceItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Item) GetBillingItem() (resp datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Item", "getBillingItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Item) GetCategory() (resp datatypes.Product_Item_Category, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Item", "getCategory", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Item) GetChildren() (resp []datatypes.Billing_Invoice_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Item", "getChildren", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Item) GetFilteredAssociatedChildren() (resp []datatypes.Billing_Invoice_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Item", "getFilteredAssociatedChildren", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Item) GetInvoice() (resp datatypes.Billing_Invoice, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Item", "getInvoice", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Item) GetLocation() (resp datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Item", "getLocation", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Item) GetNonZeroAssociatedChildren() (resp []datatypes.Billing_Invoice_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Item", "getNonZeroAssociatedChildren", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Item) GetObject() (resp datatypes.Billing_Invoice_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Item", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Item) GetParent() (resp datatypes.Billing_Invoice_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Item", "getParent", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Item) GetProduct() (resp datatypes.Product_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Item", "getProduct", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Item) GetTotalOneTimeAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Item", "getTotalOneTimeAmount", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve An invoice Item's total, including any child invoice items if they exist.
func (r Billing_Invoice_Item) GetTotalOneTimeTaxAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Item", "getTotalOneTimeTaxAmount", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve An invoice Item's total, including any child invoice items if they exist.
func (r Billing_Invoice_Item) GetTotalRecurringAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Item", "getTotalRecurringAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Item) GetTotalRecurringTaxAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Item", "getTotalRecurringTaxAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Next) GetExcel(documentCreateDate *datatypes.Time) (resp []byte, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Invoice_Next", "getExcel", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Next) GetPdf(documentCreateDate *datatypes.Time) (resp []byte, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Invoice_Next", "getPdf", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Next) GetPdfDetailed(documentCreateDate *datatypes.Time) (resp []byte, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Invoice_Next", "getPdfDetailed", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Tax_Status) GetAllObjects() (resp []datatypes.Billing_Invoice_Tax_Status, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Tax_Status", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Billing_Invoice_Tax_Status) GetObject() (resp datatypes.Billing_Invoice_Tax_Status, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Tax_Status", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Invoice_Tax_Type) GetAllObjects() (resp []datatypes.Billing_Invoice_Tax_Type, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Tax_Type", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Billing_Invoice_Tax_Type) GetObject() (resp datatypes.Billing_Invoice_Tax_Type, err error) {
	err = invokeMethod("SoftLayer_Billing_Invoice_Tax_Type", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) CancelItem(cancelImmediately *bool, cancelAssociatedBillingItems *bool, reason *string, customerNote *string) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Item", "cancelItem", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) CancelService() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "cancelService", nil, r.Session, &r.Options, &resp)
	return
}

// Cancel the resource or service for a billing Item
func (r Billing_Item) CancelServiceOnAnniversaryDate() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "cancelServiceOnAnniversaryDate", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The account that a billing item belongs to.
func (r Billing_Item) GetAccount() (resp datatypes.Account, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getAccount", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Item) GetActiveAgreement() (resp datatypes.Account_Agreement, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getActiveAgreement", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetActiveAgreementFlag() (resp datatypes.Account_Agreement, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getActiveAgreementFlag", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetActiveAssociatedChildren() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getActiveAssociatedChildren", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Item) GetActiveAssociatedGuestDiskBillingItems() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getActiveAssociatedGuestDiskBillingItems", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetActiveBundledItems() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getActiveBundledItems", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetActiveCancellationItem() (resp datatypes.Billing_Item_Cancellation_Request_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getActiveCancellationItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetActiveChildren() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getActiveChildren", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Item) GetActiveFlag() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getActiveFlag", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Item) GetActiveSparePoolAssociatedGuestDiskBillingItems() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getActiveSparePoolAssociatedGuestDiskBillingItems", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetActiveSparePoolBundledItems() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getActiveSparePoolBundledItems", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetAssociatedBillingItem() (resp datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getAssociatedBillingItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetAssociatedBillingItemHistory() (resp []datatypes.Billing_Item_Association_History, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getAssociatedBillingItemHistory", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetAssociatedChildren() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getAssociatedChildren", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetAssociatedParent() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getAssociatedParent", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Item) GetAvailableMatchingVlans() (resp []datatypes.Network_Vlan, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getAvailableMatchingVlans", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetBandwidthAllocation() (resp datatypes.Network_Bandwidth_Version1_Allocation, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getBandwidthAllocation", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetBillableChildren() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getBillableChildren", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetBundleItems() (resp []datatypes.Product_Item_Bundles, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getBundleItems", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A Billing Item's bundled billing items'
func (r Billing_Item) GetBundledItems() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getBundledItems", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A Billing Item's active child billing items.
func (r Billing_Item) GetCanceledChildren() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getCanceledChildren", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetCancellationReason() (resp datatypes.Billing_Item_Cancellation_Reason, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getCancellationReason", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetCancellationRequests() (resp []datatypes.Billing_Item_Cancellation_Request, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getCancellationRequests", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetCategory() (resp datatypes.Product_Item_Category, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getCategory", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A Billing Item's child billing items'
func (r Billing_Item) GetChildren() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getChildren", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A Billing Item's active child billing items.
func (r Billing_Item) GetChildrenWithActiveAgreement() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getChildrenWithActiveAgreement", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetDowngradeItems() (resp []datatypes.Product_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getDowngradeItems", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetFilteredNextInvoiceChildren() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getFilteredNextInvoiceChildren", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetHourlyFlag() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getHourlyFlag", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetInvoiceItem() (resp datatypes.Billing_Invoice_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getInvoiceItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetInvoiceItems() (resp []datatypes.Billing_Invoice_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getInvoiceItems", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetItem() (resp datatypes.Product_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetLocation() (resp datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getLocation", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetNextInvoiceChildren() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getNextInvoiceChildren", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A Billing Item's total, including any child billing items if they exist.'
func (r Billing_Item) GetNextInvoiceTotalOneTimeAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getNextInvoiceTotalOneTimeAmount", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A Billing Item's total, including any child billing items if they exist.'
func (r Billing_Item) GetNextInvoiceTotalOneTimeTaxAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getNextInvoiceTotalOneTimeTaxAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetNextInvoiceTotalRecurringAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getNextInvoiceTotalRecurringAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetNextInvoiceTotalRecurringTaxAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getNextInvoiceTotalRecurringTaxAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetNonZeroNextInvoiceChildren() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getNonZeroNextInvoiceChildren", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetObject() (resp datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetOrderItem() (resp datatypes.Billing_Order_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getOrderItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetOriginalLocation() (resp datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getOriginalLocation", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetPackage() (resp datatypes.Product_Package, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getPackage", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetParent() (resp datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getParent", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A billing item's parent item. If a billing item has no parent item then this value is null.
func (r Billing_Item) GetParentVirtualGuestBillingItem() (resp datatypes.Billing_Item_Virtual_Guest, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getParentVirtualGuestBillingItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetPendingCancellationFlag() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getPendingCancellationFlag", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetPendingOrderItem() (resp datatypes.Billing_Order_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getPendingOrderItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetProvisionTransaction() (resp datatypes.Provisioning_Version1_Transaction, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getProvisionTransaction", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetServiceBillingItemsByCategory(categoryCode *string, includeZeroRecurringFee *bool) (resp []datatypes.Billing_Item, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Item", "getServiceBillingItemsByCategory", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetSoftwareDescription() (resp datatypes.Software_Description, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getSoftwareDescription", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetUpgradeItem() (resp datatypes.Product_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getUpgradeItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) GetUpgradeItems() (resp []datatypes.Product_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "getUpgradeItems", nil, r.Session, &r.Options, &resp)
	return
}

// Remove the association from a billing item.
func (r Billing_Item) RemoveAssociationId() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "removeAssociationId", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item) SetAssociationId(associatedId *int) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Item", "setAssociationId", params, r.Session, &r.Options, &resp)
	return
}

// Void a previously made cancellation for a service
func (r Billing_Item) VoidCancelService() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Billing_Item", "voidCancelService", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Reason) GetAllCancellationReasons() (resp []datatypes.Billing_Item_Cancellation_Reason, err error) {
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Reason", "getAllCancellationReasons", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Reason) GetBillingCancellationReasonCategory() (resp datatypes.Billing_Item_Cancellation_Reason_Category, err error) {
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Reason", "getBillingCancellationReasonCategory", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Reason) GetBillingItems() (resp []datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Reason", "getBillingItems", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Billing_Item_Cancellation_Reason) GetObject() (resp datatypes.Billing_Item_Cancellation_Reason, err error) {
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Reason", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Item_Cancellation_Reason) GetTranslatedReason() (resp string, err error) {
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Reason", "getTranslatedReason", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Reason_Category) GetAllCancellationReasonCategories() (resp []datatypes.Billing_Item_Cancellation_Reason_Category, err error) {
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Reason_Category", "getAllCancellationReasonCategories", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Reason_Category) GetBillingCancellationReasons() (resp []datatypes.Billing_Item_Cancellation_Reason, err error) {
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Reason_Category", "getBillingCancellationReasons", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Reason_Category) GetObject() (resp datatypes.Billing_Item_Cancellation_Reason_Category, err error) {
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Reason_Category", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Request) CreateObject(templateObject *datatypes.Billing_Item_Cancellation_Request) (resp datatypes.Billing_Item_Cancellation_Request, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Request", "createObject", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Request) GetAccount() (resp datatypes.Account, err error) {
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Request", "getAccount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Request) GetAllCancellationRequests() (resp []datatypes.Billing_Item_Cancellation_Request, err error) {
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Request", "getAllCancellationRequests", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Request) GetCancellationCutoffDate(accountId *int, categoryCode *string) (resp datatypes.Time, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Request", "getCancellationCutoffDate", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Request) GetItems() (resp []datatypes.Billing_Item_Cancellation_Request_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Request", "getItems", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Request) GetObject() (resp datatypes.Billing_Item_Cancellation_Request, err error) {
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Request", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Request) GetStatus() (resp datatypes.Billing_Item_Cancellation_Request_Status, err error) {
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Request", "getStatus", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Request) GetTicket() (resp datatypes.Ticket, err error) {
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Request", "getTicket", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Request) GetUser() (resp datatypes.User_Customer, err error) {
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Request", "getUser", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Request) RemoveCancellationItem(itemId *int) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Request", "removeCancellationItem", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Request) ValidateBillingItemForCancellation(billingItemId *int) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Request", "validateBillingItemForCancellation", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Item_Cancellation_Request) Void(closeRelatedTicketFlag *bool) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Item_Cancellation_Request", "void", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) ApproveModifiedOrder() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "approveModifiedOrder", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetAccount() (resp datatypes.Account, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getAccount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetAllObjects() (resp []datatypes.Billing_Order, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Order) GetBrand() (resp datatypes.Brand, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getBrand", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetCart() (resp datatypes.Billing_Order_Cart, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getCart", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetCoreRestrictedItems() (resp []datatypes.Billing_Order_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getCoreRestrictedItems", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetCreditCardTransactions() (resp []datatypes.Billing_Payment_Card_Transaction, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getCreditCardTransactions", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Order) GetExchangeRate() (resp datatypes.Billing_Currency_ExchangeRate, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getExchangeRate", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Order) GetInitialInvoice() (resp datatypes.Billing_Invoice, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getInitialInvoice", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetItems() (resp []datatypes.Billing_Order_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getItems", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetObject() (resp datatypes.Billing_Order, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Order) GetOrderApprovalDate() (resp datatypes.Time, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getOrderApprovalDate", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetOrderNonServerMonthlyAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getOrderNonServerMonthlyAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetOrderServerMonthlyAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getOrderServerMonthlyAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetOrderStatuses() (resp []datatypes.Container_Billing_Order_Status, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getOrderStatuses", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetOrderTopLevelItems() (resp []datatypes.Billing_Order_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getOrderTopLevelItems", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetOrderTotalAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getOrderTotalAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetOrderTotalOneTime() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getOrderTotalOneTime", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetOrderTotalOneTimeAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getOrderTotalOneTimeAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetOrderTotalOneTimeTaxAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getOrderTotalOneTimeTaxAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetOrderTotalRecurring() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getOrderTotalRecurring", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetOrderTotalRecurringAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getOrderTotalRecurringAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetOrderTotalRecurringTaxAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getOrderTotalRecurringTaxAmount", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve An order's total setup fee.
func (r Billing_Order) GetOrderTotalSetupAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getOrderTotalSetupAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetOrderType() (resp datatypes.Billing_Order_Type, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getOrderType", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetPaypalTransactions() (resp []datatypes.Billing_Payment_PayPal_Transaction, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getPaypalTransactions", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetPdf() (resp []byte, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getPdf", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve the default filename of an order PDF.
func (r Billing_Order) GetPdfFilename() (resp string, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getPdfFilename", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Order) GetPresaleEvent() (resp datatypes.Sales_Presale_Event, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getPresaleEvent", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetQuote() (resp datatypes.Billing_Order_Quote, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getQuote", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetRecalculatedOrderContainer(message *string, ignoreDiscountsFlag *bool) (resp datatypes.Container_Product_Order, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Order", "getRecalculatedOrderContainer", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetReceipt() (resp datatypes.Container_Product_Order_Receipt, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getReceipt", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetReferralPartner() (resp datatypes.Account, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getReferralPartner", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve This flag indicates an order is an upgrade.
func (r Billing_Order) GetUpgradeRequestFlag() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getUpgradeRequestFlag", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) GetUserRecord() (resp datatypes.User_Customer, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "getUserRecord", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order) IsPendingEditApproval() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Billing_Order", "isPendingEditApproval", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Cart) Claim(quoteKey *string, quoteId *int) (resp datatypes.Billing_Order_Quote, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "claim", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Cart) CreateCart(orderData *datatypes.Container_Product_Order) (resp int, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "createCart", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Cart) DeleteCart() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "deleteCart", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Cart) DeleteQuote() (resp datatypes.Billing_Order_Quote, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "deleteQuote", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A quote's corresponding account.
func (r Billing_Order_Cart) GetAccount() (resp datatypes.Account, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "getAccount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Cart) GetCartByCartKey(cartKey *string) (resp datatypes.Billing_Order_Cart, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "getCartByCartKey", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Billing_Order_Cart) GetObject() (resp datatypes.Billing_Order_Cart, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Cart) GetOrder() (resp datatypes.Billing_Order, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "getOrder", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Cart) GetOrdersFromQuote() (resp []datatypes.Billing_Order, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "getOrdersFromQuote", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve a PDF copy of the cart.
func (r Billing_Order_Cart) GetPdf() (resp []byte, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "getPdf", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Cart) GetQuoteByQuoteKey(quoteKey *string) (resp datatypes.Billing_Order_Quote, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "getQuoteByQuoteKey", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Cart) GetRecalculatedOrderContainer(orderData *datatypes.Container_Product_Order, orderBeingPlacedFlag *bool) (resp datatypes.Container_Product_Order, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "getRecalculatedOrderContainer", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Cart) PlaceOrder(orderData *datatypes.Container_Product_Order) (resp datatypes.Container_Product_Order_Receipt, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "placeOrder", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Cart) PlaceQuote(orderData *datatypes.Container_Product_Order) (resp datatypes.Container_Product_Order, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "placeQuote", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Cart) SaveQuote() (resp datatypes.Billing_Order_Quote, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "saveQuote", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Cart) UpdateCart(orderData *datatypes.Container_Product_Order) (resp int, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "updateCart", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Cart) VerifyOrder(orderData *datatypes.Container_Product_Order) (resp datatypes.Container_Product_Order, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Order_Cart", "verifyOrder", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetBillingItem() (resp datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getBillingItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetBundledItems() (resp []datatypes.Billing_Order_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getBundledItems", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetCategory() (resp datatypes.Product_Item_Category, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getCategory", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetChildren() (resp []datatypes.Billing_Order_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getChildren", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A hardware's universally unique identifier.
func (r Billing_Order_Item) GetGlobalIdentifier() (resp string, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getGlobalIdentifier", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetHardwareGenericComponent() (resp datatypes.Hardware_Component_Model_Generic, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getHardwareGenericComponent", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetItem() (resp datatypes.Product_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetItemCategoryAnswers() (resp []datatypes.Billing_Order_Item_Category_Answer, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getItemCategoryAnswers", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetItemPrice() (resp datatypes.Product_Item_Price, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getItemPrice", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetLocation() (resp datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getLocation", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Order_Item) GetNextOrderChildren() (resp []datatypes.Billing_Order_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getNextOrderChildren", nil, r.Session, &r.Options, &resp)
	return
}

// getObject retrieves the SoftLayer_Billing_Item object whose ID number corresponds to the ID number of the init parameter passed to the SoftLayer_Billing_Item service. You can only retrieve billing items tied to the account that your portal user is assigned to. Billing items are an account's items of billable items. There are "parent" billing items and "child" billing items. The server billing item is generally referred to as a parent billing item. The items tied to a server, such as ram, harddrives, and operating systems are considered "child" billing items.
func (r Billing_Order_Item) GetObject() (resp datatypes.Billing_Order_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetOldBillingItem() (resp datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getOldBillingItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetOrder() (resp datatypes.Billing_Order, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getOrder", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Billing_Order_Item) GetOrderApprovalDate() (resp datatypes.Time, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getOrderApprovalDate", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetPackage() (resp datatypes.Product_Package, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getPackage", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetParent() (resp datatypes.Billing_Order_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getParent", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetRedundantPowerSupplyCount() (resp uint, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getRedundantPowerSupplyCount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetSoftwareDescription() (resp datatypes.Software_Description, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getSoftwareDescription", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetStorageGroups() (resp []datatypes.Configuration_Storage_Group_Order, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getStorageGroups", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetTotalRecurringAmount() (resp float64, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getTotalRecurringAmount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Item) GetUpgradeItem() (resp datatypes.Product_Item, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Item", "getUpgradeItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Quote) Claim(quoteKey *string, quoteId *int) (resp datatypes.Billing_Order_Quote, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Order_Quote", "claim", params, r.Session, &r.Options, &resp)
	return
}

// Account master users and sub-users in the SoftLayer customer portal can delete the quote of an order.
func (r Billing_Order_Quote) DeleteQuote() (resp datatypes.Billing_Order_Quote, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Quote", "deleteQuote", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve A quote's corresponding account.
func (r Billing_Order_Quote) GetAccount() (resp datatypes.Account, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Quote", "getAccount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Quote) GetObject() (resp datatypes.Billing_Order_Quote, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Quote", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve This order contains the records for which products were selected for this quote.
func (r Billing_Order_Quote) GetOrder() (resp datatypes.Billing_Order, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Quote", "getOrder", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve These are all the orders that were created from this quote.
func (r Billing_Order_Quote) GetOrdersFromQuote() (resp []datatypes.Billing_Order, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Quote", "getOrdersFromQuote", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Quote) GetPdf() (resp []byte, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Quote", "getPdf", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Quote) GetQuoteByQuoteKey(quoteKey *string) (resp datatypes.Billing_Order_Quote, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Order_Quote", "getQuoteByQuoteKey", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Quote) GetRecalculatedOrderContainer(orderData *datatypes.Container_Product_Order, orderBeingPlacedFlag *bool) (resp datatypes.Container_Product_Order, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Order_Quote", "getRecalculatedOrderContainer", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Quote) PlaceOrder(orderData *datatypes.Container_Product_Order) (resp datatypes.Container_Product_Order_Receipt, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Order_Quote", "placeOrder", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Quote) PlaceQuote(orderData *datatypes.Container_Product_Order) (resp datatypes.Container_Product_Order, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Order_Quote", "placeQuote", params, r.Session, &r.Options, &resp)
	return
}

// Account master users and sub-users in the SoftLayer customer portal can save the quote of an order to avoid its deletion after 5 days or its expiration after 2 days.
func (r Billing_Order_Quote) SaveQuote() (resp datatypes.Billing_Order_Quote, err error) {
	err = invokeMethod("SoftLayer_Billing_Order_Quote", "saveQuote", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Billing_Order_Quote) VerifyOrder(orderData *datatypes.Container_Product_Order) (resp datatypes.Container_Product_Order, err error) {
	...
	err = invokeMethod("SoftLayer_Billing_Order_Quote", "verifyOrder", params, r.Session, &r.Options, &resp)
	return
}
