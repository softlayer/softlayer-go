...
func (r Catalyst_Company_Type) GetAllObjects() (resp []datatypes.Catalyst_Company_Type, err error) {
	err = invokeMethod("SoftLayer_Catalyst_Company_Type", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Catalyst_Company_Type) GetObject() (resp datatypes.Catalyst_Company_Type, err error) {
	err = invokeMethod("SoftLayer_Catalyst_Company_Type", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Catalyst_Enrollment) GetAccount() (resp datatypes.Account, err error) {
	err = invokeMethod("SoftLayer_Catalyst_Enrollment", "getAccount", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Catalyst_Enrollment) GetAffiliate() (resp datatypes.Catalyst_Affiliate, err error) {
	err = invokeMethod("SoftLayer_Catalyst_Enrollment", "getAffiliate", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Catalyst_Enrollment) GetAffiliates() (resp []datatypes.Catalyst_Affiliate, err error) {
	err = invokeMethod("SoftLayer_Catalyst_Enrollment", "getAffiliates", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Catalyst_Enrollment) GetCompanyType() (resp datatypes.Catalyst_Company_Type, err error) {
	err = invokeMethod("SoftLayer_Catalyst_Enrollment", "getCompanyType", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Catalyst_Enrollment) GetCompanyTypes() (resp []datatypes.Catalyst_Company_Type, err error) {
	err = invokeMethod("SoftLayer_Catalyst_Enrollment", "getCompanyTypes", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Catalyst_Enrollment) GetEnrollmentRequestAnnualRevenueOptions() (resp []datatypes.Catalyst_Enrollment_Request_Container_AnswerOption, err error) {
	err = invokeMethod("SoftLayer_Catalyst_Enrollment", "getEnrollmentRequestAnnualRevenueOptions", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Catalyst_Enrollment) GetEnrollmentRequestUserCountOptions() (resp []datatypes.Catalyst_Enrollment_Request_Container_AnswerOption, err error) {
	err = invokeMethod("SoftLayer_Catalyst_Enrollment", "getEnrollmentRequestUserCountOptions", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Catalyst_Enrollment) GetEnrollmentRequestYearsInOperationOptions() (resp []datatypes.Catalyst_Enrollment_Request_Container_AnswerOption, err error) {
	err = invokeMethod("SoftLayer_Catalyst_Enrollment", "getEnrollmentRequestYearsInOperationOptions", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Catalyst_Enrollment) GetIsActiveFlag() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Catalyst_Enrollment", "getIsActiveFlag", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Catalyst_Enrollment) GetObject() (resp datatypes.Catalyst_Enrollment, err error) {
	err = invokeMethod("SoftLayer_Catalyst_Enrollment", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Catalyst_Enrollment) GetRepresentative() (resp datatypes.User_Employee, err error) {
	err = invokeMethod("SoftLayer_Catalyst_Enrollment", "getRepresentative", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Catalyst_Enrollment) RequestManualEnrollment(request *datatypes.Container_Catalyst_ManualEnrollmentRequest) (err error) {
	...
	err = invokeMethod("SoftLayer_Catalyst_Enrollment", "requestManualEnrollment", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Catalyst_Enrollment) RequestSelfEnrollment(enrollmentRequest *datatypes.Catalyst_Enrollment_Request) (resp datatypes.Account, err error) {
	...
	err = invokeMethod("SoftLayer_Catalyst_Enrollment", "requestSelfEnrollment", params, r.Session, &r.Options, &resp)
	return
}
