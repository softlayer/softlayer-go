...
func (r Brand) CreateCustomerAccount(account *datatypes.Account, bypassDuplicateAccountCheck *bool) (resp datatypes.Account, err error) {
	...
	err = invokeMethod("SoftLayer_Brand", "createCustomerAccount", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Brand) CreateObject(templateObject *datatypes.Brand) (resp datatypes.Brand, err error) {
	...
	err = invokeMethod("SoftLayer_Brand", "createObject", params, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Brand) GetAccount() (resp datatypes.Account, err error) {
	err = invokeMethod("SoftLayer_Brand", "getAccount", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve All accounts owned by the brand.
func (r Brand) GetAllOwnedAccounts() (resp []datatypes.Account, err error) {
	err = invokeMethod("SoftLayer_Brand", "getAllOwnedAccounts", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Brand) GetAllTicketSubjects(account *datatypes.Account) (resp []datatypes.Ticket_Subject, err error) {
	...
	err = invokeMethod("SoftLayer_Brand", "getAllTicketSubjects", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Brand) GetAllowAccountCreationFlag() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Brand", "getAllowAccountCreationFlag", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The Product Catalog for the Brand
func (r Brand) GetCatalog() (resp datatypes.Product_Catalog, err error) {
	err = invokeMethod("SoftLayer_Brand", "getCatalog", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Brand) GetContactInformation() (resp []datatypes.Brand_Contact, err error) {
	err = invokeMethod("SoftLayer_Brand", "getContactInformation", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The contacts for the brand.
func (r Brand) GetContacts() (resp []datatypes.Brand_Contact, err error) {
	err = invokeMethod("SoftLayer_Brand", "getContacts", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Brand) GetCustomerCountryLocationRestrictions() (resp []datatypes.Brand_Restriction_Location_CustomerCountry, err error) {
	err = invokeMethod("SoftLayer_Brand", "getCustomerCountryLocationRestrictions", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Brand) GetDistributor() (resp datatypes.Brand, err error) {
	err = invokeMethod("SoftLayer_Brand", "getDistributor", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Brand) GetDistributorChildFlag() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Brand", "getDistributorChildFlag", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Brand) GetDistributorFlag() (resp string, err error) {
	err = invokeMethod("SoftLayer_Brand", "getDistributorFlag", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve An account's associated hardware objects.
func (r Brand) GetHardware() (resp []datatypes.Hardware, err error) {
	err = invokeMethod("SoftLayer_Brand", "getHardware", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Brand) GetHasAgentSupportFlag() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Brand", "getHasAgentSupportFlag", nil, r.Session, &r.Options, &resp)
	return
}

// Get the payment processor merchant name.
func (r Brand) GetMerchantName() (resp string, err error) {
	err = invokeMethod("SoftLayer_Brand", "getMerchantName", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Brand) GetObject() (resp datatypes.Brand, err error) {
	err = invokeMethod("SoftLayer_Brand", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Brand) GetOpenTickets() (resp []datatypes.Ticket, err error) {
	err = invokeMethod("SoftLayer_Brand", "getOpenTickets", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve Active accounts owned by the brand.
func (r Brand) GetOwnedAccounts() (resp []datatypes.Account, err error) {
	err = invokeMethod("SoftLayer_Brand", "getOwnedAccounts", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Brand) GetTicketGroups() (resp []datatypes.Ticket_Group, err error) {
	err = invokeMethod("SoftLayer_Brand", "getTicketGroups", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Brand) GetTickets() (resp []datatypes.Ticket, err error) {
	err = invokeMethod("SoftLayer_Brand", "getTickets", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Brand) GetToken(userId *int) (resp string, err error) {
	...
	err = invokeMethod("SoftLayer_Brand", "getToken", params, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Brand) GetUsers() (resp []datatypes.User_Customer, err error) {
	err = invokeMethod("SoftLayer_Brand", "getUsers", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Brand) GetVirtualGuests() (resp []datatypes.Virtual_Guest, err error) {
	err = invokeMethod("SoftLayer_Brand", "getVirtualGuests", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Brand_Restriction_Location_CustomerCountry) GetAllObjects() (resp []datatypes.Brand_Restriction_Location_CustomerCountry, err error) {
	err = invokeMethod("SoftLayer_Brand_Restriction_Location_CustomerCountry", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Brand_Restriction_Location_CustomerCountry) GetBrand() (resp datatypes.Brand, err error) {
	err = invokeMethod("SoftLayer_Brand_Restriction_Location_CustomerCountry", "getBrand", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Brand_Restriction_Location_CustomerCountry) GetLocation() (resp datatypes.Location, err error) {
	err = invokeMethod("SoftLayer_Brand_Restriction_Location_CustomerCountry", "getLocation", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Brand_Restriction_Location_CustomerCountry) GetObject() (resp datatypes.Brand_Restriction_Location_CustomerCountry, err error) {
	err = invokeMethod("SoftLayer_Brand_Restriction_Location_CustomerCountry", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
