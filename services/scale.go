...
func (r Scale_Asset) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_Asset", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Asset) GetObject() (resp datatypes.Scale_Asset, err error) {
	err = invokeMethod("SoftLayer_Scale_Asset", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The group this asset belongs to.
func (r Scale_Asset) GetScaleGroup() (resp datatypes.Scale_Group, err error) {
	err = invokeMethod("SoftLayer_Scale_Asset", "getScaleGroup", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Asset_Hardware) CreateObject(templateObject *datatypes.Scale_Asset_Hardware) (resp datatypes.Scale_Asset_Hardware, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Asset_Hardware", "createObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Asset_Hardware) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_Asset_Hardware", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The hardware for this asset.
func (r Scale_Asset_Hardware) GetHardware() (resp datatypes.Hardware, err error) {
	err = invokeMethod("SoftLayer_Scale_Asset_Hardware", "getHardware", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The identifier of the hardware for this asset.
func (r Scale_Asset_Hardware) GetHardwareId() (resp int, err error) {
	err = invokeMethod("SoftLayer_Scale_Asset_Hardware", "getHardwareId", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Asset_Hardware) GetObject() (resp datatypes.Scale_Asset_Hardware, err error) {
	err = invokeMethod("SoftLayer_Scale_Asset_Hardware", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The group this asset belongs to.
func (r Scale_Asset_Hardware) GetScaleGroup() (resp datatypes.Scale_Group, err error) {
	err = invokeMethod("SoftLayer_Scale_Asset_Hardware", "getScaleGroup", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Asset_Virtual_Guest) CreateObject(templateObject *datatypes.Scale_Asset_Virtual_Guest) (resp datatypes.Scale_Asset_Virtual_Guest, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Asset_Virtual_Guest", "createObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Asset_Virtual_Guest) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_Asset_Virtual_Guest", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Asset_Virtual_Guest) GetObject() (resp datatypes.Scale_Asset_Virtual_Guest, err error) {
	err = invokeMethod("SoftLayer_Scale_Asset_Virtual_Guest", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The group this asset belongs to.
func (r Scale_Asset_Virtual_Guest) GetScaleGroup() (resp datatypes.Scale_Group, err error) {
	err = invokeMethod("SoftLayer_Scale_Asset_Virtual_Guest", "getScaleGroup", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The guest for this asset.
func (r Scale_Asset_Virtual_Guest) GetVirtualGuest() (resp datatypes.Virtual_Guest, err error) {
	err = invokeMethod("SoftLayer_Scale_Asset_Virtual_Guest", "getVirtualGuest", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The identifier of the guest for this asset.
func (r Scale_Asset_Virtual_Guest) GetVirtualGuestId() (resp int, err error) {
	err = invokeMethod("SoftLayer_Scale_Asset_Virtual_Guest", "getVirtualGuestId", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Group) CreateObject(templateObject *datatypes.Scale_Group) (resp datatypes.Scale_Group, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Group", "createObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Group) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_Group", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Group) EditObject(templateObject *datatypes.Scale_Group) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Group", "editObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Group) ForceDeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_Group", "forceDeleteObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The account for this scaling group.
func (r Scale_Group) GetAccount() (resp datatypes.Account, err error) {
	err = invokeMethod("SoftLayer_Scale_Group", "getAccount", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Group) GetAvailableHourlyInstanceLimit() (resp int, err error) {
	err = invokeMethod("SoftLayer_Scale_Group", "getAvailableHourlyInstanceLimit", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Group) GetAvailableRegionalGroups() (resp []datatypes.Location_Group, err error) {
	err = invokeMethod("SoftLayer_Scale_Group", "getAvailableRegionalGroups", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Group) GetLoadBalancers() (resp []datatypes.Scale_LoadBalancer, err error) {
	err = invokeMethod("SoftLayer_Scale_Group", "getLoadBalancers", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve Collection of log entries for this group.
func (r Scale_Group) GetLogs() (resp []datatypes.Scale_Group_Log, err error) {
	err = invokeMethod("SoftLayer_Scale_Group", "getLogs", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Group) GetNetworkVlans() (resp []datatypes.Scale_Network_Vlan, err error) {
	err = invokeMethod("SoftLayer_Scale_Group", "getNetworkVlans", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Group) GetObject() (resp datatypes.Scale_Group, err error) {
	err = invokeMethod("SoftLayer_Scale_Group", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Group) GetPolicies() (resp []datatypes.Scale_Policy, err error) {
	err = invokeMethod("SoftLayer_Scale_Group", "getPolicies", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Group) GetRegionalGroup() (resp datatypes.Location_Group_Regional, err error) {
	err = invokeMethod("SoftLayer_Scale_Group", "getRegionalGroup", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The status for this scale group.
func (r Scale_Group) GetStatus() (resp datatypes.Scale_Group_Status, err error) {
	err = invokeMethod("SoftLayer_Scale_Group", "getStatus", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Group) GetTerminationPolicy() (resp datatypes.Scale_Termination_Policy, err error) {
	err = invokeMethod("SoftLayer_Scale_Group", "getTerminationPolicy", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Group) GetVirtualGuestAssets() (resp []datatypes.Scale_Asset_Virtual_Guest, err error) {
	err = invokeMethod("SoftLayer_Scale_Group", "getVirtualGuestAssets", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Group) GetVirtualGuestMembers() (resp []datatypes.Scale_Member_Virtual_Guest, err error) {
	err = invokeMethod("SoftLayer_Scale_Group", "getVirtualGuestMembers", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Group) Resume() (err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Group", "resume", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Group) Scale(delta *int) (resp []datatypes.Scale_Member, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Group", "scale", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Group) ScaleTo(number *int) (resp []datatypes.Scale_Member, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Group", "scaleTo", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Group) Suspend() (err error) {
	var resp datatypes.Void
	err = invokeMethod("SoftLayer_Scale_Group", "suspend", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Group_Status) GetAllObjects() (resp []datatypes.Scale_Group_Status, err error) {
	err = invokeMethod("SoftLayer_Scale_Group_Status", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Group_Status) GetObject() (resp datatypes.Scale_Group_Status, err error) {
	err = invokeMethod("SoftLayer_Scale_Group_Status", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_LoadBalancer) CreateObject(templateObject *datatypes.Scale_LoadBalancer) (resp datatypes.Scale_LoadBalancer, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_LoadBalancer", "createObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_LoadBalancer) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_LoadBalancer", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_LoadBalancer) EditObject(templateObject *datatypes.Scale_LoadBalancer) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_LoadBalancer", "editObject", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_LoadBalancer) GetAllocationPercent() (resp int, err error) {
	err = invokeMethod("SoftLayer_Scale_LoadBalancer", "getAllocationPercent", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_LoadBalancer) GetHealthCheck() (resp datatypes.Network_Application_Delivery_Controller_LoadBalancer_Health_Check, err error) {
	err = invokeMethod("SoftLayer_Scale_LoadBalancer", "getHealthCheck", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_LoadBalancer) GetObject() (resp datatypes.Scale_LoadBalancer, err error) {
	err = invokeMethod("SoftLayer_Scale_LoadBalancer", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_LoadBalancer) GetRoutingMethod() (resp datatypes.Network_Application_Delivery_Controller_LoadBalancer_Routing_Method, err error) {
	err = invokeMethod("SoftLayer_Scale_LoadBalancer", "getRoutingMethod", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_LoadBalancer) GetRoutingType() (resp datatypes.Network_Application_Delivery_Controller_LoadBalancer_Routing_Type, err error) {
	err = invokeMethod("SoftLayer_Scale_LoadBalancer", "getRoutingType", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_LoadBalancer) GetScaleGroup() (resp datatypes.Scale_Group, err error) {
	err = invokeMethod("SoftLayer_Scale_LoadBalancer", "getScaleGroup", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The ID of the virtual IP address.
func (r Scale_LoadBalancer) GetVirtualIpAddressId() (resp int, err error) {
	err = invokeMethod("SoftLayer_Scale_LoadBalancer", "getVirtualIpAddressId", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_LoadBalancer) GetVirtualServer() (resp datatypes.Network_Application_Delivery_Controller_LoadBalancer_VirtualServer, err error) {
	err = invokeMethod("SoftLayer_Scale_LoadBalancer", "getVirtualServer", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The port on the virtual server.
func (r Scale_LoadBalancer) GetVirtualServerPort() (resp int, err error) {
	err = invokeMethod("SoftLayer_Scale_LoadBalancer", "getVirtualServerPort", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Member) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_Member", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Member) GetObject() (resp datatypes.Scale_Member, err error) {
	err = invokeMethod("SoftLayer_Scale_Member", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The group this member belongs to.
func (r Scale_Member) GetScaleGroup() (resp datatypes.Scale_Group, err error) {
	err = invokeMethod("SoftLayer_Scale_Member", "getScaleGroup", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Member_Virtual_Guest) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_Member_Virtual_Guest", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Member_Virtual_Guest) GetObject() (resp datatypes.Scale_Member_Virtual_Guest, err error) {
	err = invokeMethod("SoftLayer_Scale_Member_Virtual_Guest", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The group this member belongs to.
func (r Scale_Member_Virtual_Guest) GetScaleGroup() (resp datatypes.Scale_Group, err error) {
	err = invokeMethod("SoftLayer_Scale_Member_Virtual_Guest", "getScaleGroup", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Member_Virtual_Guest) GetVirtualGuest() (resp datatypes.Virtual_Guest, err error) {
	err = invokeMethod("SoftLayer_Scale_Member_Virtual_Guest", "getVirtualGuest", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Member_Virtual_Guest) GetVirtualGuestId() (resp int, err error) {
	err = invokeMethod("SoftLayer_Scale_Member_Virtual_Guest", "getVirtualGuestId", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Network_Vlan) CreateObject(templateObject *datatypes.Scale_Network_Vlan) (resp datatypes.Scale_Network_Vlan, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Network_Vlan", "createObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Network_Vlan) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_Network_Vlan", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The network VLAN to scale with.
func (r Scale_Network_Vlan) GetNetworkVlan() (resp datatypes.Network_Vlan, err error) {
	err = invokeMethod("SoftLayer_Scale_Network_Vlan", "getNetworkVlan", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Network_Vlan) GetObject() (resp datatypes.Scale_Network_Vlan, err error) {
	err = invokeMethod("SoftLayer_Scale_Network_Vlan", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The group this network VLAN is for.
func (r Scale_Network_Vlan) GetScaleGroup() (resp datatypes.Scale_Group, err error) {
	err = invokeMethod("SoftLayer_Scale_Network_Vlan", "getScaleGroup", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy) CreateObject(templateObject *datatypes.Scale_Policy) (resp datatypes.Scale_Policy, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Policy", "createObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy) EditObject(templateObject *datatypes.Scale_Policy) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Policy", "editObject", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy) GetActions() (resp []datatypes.Scale_Policy_Action, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy", "getActions", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy) GetObject() (resp datatypes.Scale_Policy, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy) GetOneTimeTriggers() (resp []datatypes.Scale_Policy_Trigger_OneTime, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy", "getOneTimeTriggers", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy) GetRepeatingTriggers() (resp []datatypes.Scale_Policy_Trigger_Repeating, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy", "getRepeatingTriggers", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy) GetResourceUseTriggers() (resp []datatypes.Scale_Policy_Trigger_ResourceUse, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy", "getResourceUseTriggers", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy) GetScaleActions() (resp []datatypes.Scale_Policy_Action_Scale, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy", "getScaleActions", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The group this policy is on.
func (r Scale_Policy) GetScaleGroup() (resp datatypes.Scale_Group, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy", "getScaleGroup", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy) GetTriggers() (resp []datatypes.Scale_Policy_Trigger, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy", "getTriggers", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy) Trigger() (resp []datatypes.Scale_Member, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy", "trigger", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Action) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Action", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Action) EditObject(templateObject *datatypes.Scale_Policy_Action) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Policy_Action", "editObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Action) GetObject() (resp datatypes.Scale_Policy_Action, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Action", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The policy this action is on.
func (r Scale_Policy_Action) GetScalePolicy() (resp datatypes.Scale_Policy, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Action", "getScalePolicy", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The type of action.
func (r Scale_Policy_Action) GetType() (resp datatypes.Scale_Policy_Action_Type, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Action", "getType", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Action_Scale) CreateObject(templateObject *datatypes.Scale_Policy_Action_Scale) (resp datatypes.Scale_Policy_Action_Scale, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Policy_Action_Scale", "createObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Action_Scale) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Action_Scale", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Action_Scale) EditObject(templateObject *datatypes.Scale_Policy_Action) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Policy_Action_Scale", "editObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Action_Scale) GetObject() (resp datatypes.Scale_Policy_Action_Scale, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Action_Scale", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The policy this action is on.
func (r Scale_Policy_Action_Scale) GetScalePolicy() (resp datatypes.Scale_Policy, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Action_Scale", "getScalePolicy", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The type of action.
func (r Scale_Policy_Action_Scale) GetType() (resp datatypes.Scale_Policy_Action_Type, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Action_Scale", "getType", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Action_Type) GetAllObjects() (resp []datatypes.Scale_Policy_Action_Type, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Action_Type", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Action_Type) GetObject() (resp datatypes.Scale_Policy_Action_Type, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Action_Type", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Trigger) CreateObject(templateObject *datatypes.Scale_Policy_Trigger) (resp datatypes.Scale_Policy_Trigger, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger", "createObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Trigger) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Trigger) EditObject(templateObject *datatypes.Scale_Policy_Trigger) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger", "editObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Trigger) GetObject() (resp datatypes.Scale_Policy_Trigger, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The policy this trigger is on.
func (r Scale_Policy_Trigger) GetScalePolicy() (resp datatypes.Scale_Policy, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger", "getScalePolicy", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The type of trigger.
func (r Scale_Policy_Trigger) GetType() (resp datatypes.Scale_Policy_Trigger_Type, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger", "getType", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Trigger_OneTime) CreateObject(templateObject *datatypes.Scale_Policy_Trigger_OneTime) (resp datatypes.Scale_Policy_Trigger_OneTime, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_OneTime", "createObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Trigger_OneTime) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_OneTime", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Trigger_OneTime) EditObject(templateObject *datatypes.Scale_Policy_Trigger) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_OneTime", "editObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Trigger_OneTime) GetObject() (resp datatypes.Scale_Policy_Trigger_OneTime, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_OneTime", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The policy this trigger is on.
func (r Scale_Policy_Trigger_OneTime) GetScalePolicy() (resp datatypes.Scale_Policy, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_OneTime", "getScalePolicy", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The type of trigger.
func (r Scale_Policy_Trigger_OneTime) GetType() (resp datatypes.Scale_Policy_Trigger_Type, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_OneTime", "getType", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Trigger_Repeating) CreateObject(templateObject *datatypes.Scale_Policy_Trigger_Repeating) (resp datatypes.Scale_Policy_Trigger_Repeating, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_Repeating", "createObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Trigger_Repeating) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_Repeating", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Trigger_Repeating) EditObject(templateObject *datatypes.Scale_Policy_Trigger) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_Repeating", "editObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Trigger_Repeating) GetObject() (resp datatypes.Scale_Policy_Trigger_Repeating, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_Repeating", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The policy this trigger is on.
func (r Scale_Policy_Trigger_Repeating) GetScalePolicy() (resp datatypes.Scale_Policy, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_Repeating", "getScalePolicy", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The type of trigger.
func (r Scale_Policy_Trigger_Repeating) GetType() (resp datatypes.Scale_Policy_Trigger_Type, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_Repeating", "getType", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Trigger_Repeating) ValidateCronExpression(expression *string) (err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_Repeating", "validateCronExpression", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Trigger_ResourceUse) CreateObject(templateObject *datatypes.Scale_Policy_Trigger_ResourceUse) (resp datatypes.Scale_Policy_Trigger_ResourceUse, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_ResourceUse", "createObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Trigger_ResourceUse) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_ResourceUse", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Trigger_ResourceUse) EditObject(templateObject *datatypes.Scale_Policy_Trigger) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_ResourceUse", "editObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Trigger_ResourceUse) GetObject() (resp datatypes.Scale_Policy_Trigger_ResourceUse, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_ResourceUse", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The policy this trigger is on.
func (r Scale_Policy_Trigger_ResourceUse) GetScalePolicy() (resp datatypes.Scale_Policy, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_ResourceUse", "getScalePolicy", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The type of trigger.
func (r Scale_Policy_Trigger_ResourceUse) GetType() (resp datatypes.Scale_Policy_Trigger_Type, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_ResourceUse", "getType", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Trigger_ResourceUse) GetWatches() (resp []datatypes.Scale_Policy_Trigger_ResourceUse_Watch, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_ResourceUse", "getWatches", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Trigger_ResourceUse_Watch) CreateObject(templateObject *datatypes.Scale_Policy_Trigger_ResourceUse_Watch) (resp datatypes.Scale_Policy_Trigger_ResourceUse_Watch, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_ResourceUse_Watch", "createObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Trigger_ResourceUse_Watch) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_ResourceUse_Watch", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Trigger_ResourceUse_Watch) EditObject(templateObject *datatypes.Scale_Policy_Trigger_ResourceUse_Watch) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_ResourceUse_Watch", "editObject", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Trigger_ResourceUse_Watch) GetAllPossibleAlgorithms() (resp []string, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_ResourceUse_Watch", "getAllPossibleAlgorithms", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Trigger_ResourceUse_Watch) GetAllPossibleMetrics() (resp []string, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_ResourceUse_Watch", "getAllPossibleMetrics", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Trigger_ResourceUse_Watch) GetAllPossibleOperators() (resp []string, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_ResourceUse_Watch", "getAllPossibleOperators", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Trigger_ResourceUse_Watch) GetObject() (resp datatypes.Scale_Policy_Trigger_ResourceUse_Watch, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_ResourceUse_Watch", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Trigger_ResourceUse_Watch) GetScalePolicyTrigger() (resp datatypes.Scale_Policy_Trigger_ResourceUse, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_ResourceUse_Watch", "getScalePolicyTrigger", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Policy_Trigger_Type) GetAllObjects() (resp []datatypes.Scale_Policy_Trigger_Type, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_Type", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Policy_Trigger_Type) GetObject() (resp datatypes.Scale_Policy_Trigger_Type, err error) {
	err = invokeMethod("SoftLayer_Scale_Policy_Trigger_Type", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Scale_Termination_Policy) GetAllObjects() (resp []datatypes.Scale_Termination_Policy, err error) {
	err = invokeMethod("SoftLayer_Scale_Termination_Policy", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Scale_Termination_Policy) GetObject() (resp datatypes.Scale_Termination_Policy, err error) {
	err = invokeMethod("SoftLayer_Scale_Termination_Policy", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
