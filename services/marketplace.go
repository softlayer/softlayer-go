...
func (r Marketplace_Partner) GetAllObjects() (resp []datatypes.Marketplace_Partner, err error) {
	err = invokeMethod("SoftLayer_Marketplace_Partner", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Marketplace_Partner) GetAllPublishedPartners(searchTerm *string) (resp []datatypes.Marketplace_Partner, err error) {
	...
	err = invokeMethod("SoftLayer_Marketplace_Partner", "getAllPublishedPartners", params, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Marketplace_Partner) GetAttachments() (resp []datatypes.Marketplace_Partner_Attachment, err error) {
	err = invokeMethod("SoftLayer_Marketplace_Partner", "getAttachments", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Marketplace_Partner) GetFeaturedPartners(non *bool) (resp []datatypes.Marketplace_Partner, err error) {
	...
	err = invokeMethod("SoftLayer_Marketplace_Partner", "getFeaturedPartners", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Marketplace_Partner) GetFile(name *string) (resp datatypes.Marketplace_Partner_File, err error) {
	...
	err = invokeMethod("SoftLayer_Marketplace_Partner", "getFile", params, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Marketplace_Partner) GetLogoMedium() (resp datatypes.Marketplace_Partner_Attachment, err error) {
	err = invokeMethod("SoftLayer_Marketplace_Partner", "getLogoMedium", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Marketplace_Partner) GetLogoMediumTemp() (resp datatypes.Marketplace_Partner_Attachment, err error) {
	err = invokeMethod("SoftLayer_Marketplace_Partner", "getLogoMediumTemp", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Marketplace_Partner) GetLogoSmall() (resp datatypes.Marketplace_Partner_Attachment, err error) {
	err = invokeMethod("SoftLayer_Marketplace_Partner", "getLogoSmall", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Marketplace_Partner) GetLogoSmallTemp() (resp datatypes.Marketplace_Partner_Attachment, err error) {
	err = invokeMethod("SoftLayer_Marketplace_Partner", "getLogoSmallTemp", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Marketplace_Partner) GetObject() (resp datatypes.Marketplace_Partner, err error) {
	err = invokeMethod("SoftLayer_Marketplace_Partner", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Marketplace_Partner) GetPartnerByUrlIdentifier(urlIdentifier *string) (resp datatypes.Marketplace_Partner, err error) {
	...
	err = invokeMethod("SoftLayer_Marketplace_Partner", "getPartnerByUrlIdentifier", params, r.Session, &r.Options, &resp)
	return
}
