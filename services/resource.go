...
func (r Resource_Group) EditObject(templateObject *datatypes.Resource_Group) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Resource_Group", "editObject", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Group) GetAncestorGroups() (resp []datatypes.Resource_Group, err error) {
	err = invokeMethod("SoftLayer_Resource_Group", "getAncestorGroups", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Group) GetAttributes() (resp []datatypes.Resource_Group_Attribute, err error) {
	err = invokeMethod("SoftLayer_Resource_Group", "getAttributes", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Group) GetHardwareMembers() (resp []datatypes.Resource_Group_Member, err error) {
	err = invokeMethod("SoftLayer_Resource_Group", "getHardwareMembers", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Group) GetMembers() (resp []datatypes.Resource_Group_Member, err error) {
	err = invokeMethod("SoftLayer_Resource_Group", "getMembers", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Resource_Group) GetObject() (resp datatypes.Resource_Group, err error) {
	err = invokeMethod("SoftLayer_Resource_Group", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Group) GetRootResourceGroup() (resp datatypes.Resource_Group, err error) {
	err = invokeMethod("SoftLayer_Resource_Group", "getRootResourceGroup", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Group) GetSubnetMembers() (resp []datatypes.Resource_Group_Member, err error) {
	err = invokeMethod("SoftLayer_Resource_Group", "getSubnetMembers", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Group) GetTemplate() (resp datatypes.Resource_Group_Template, err error) {
	err = invokeMethod("SoftLayer_Resource_Group", "getTemplate", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Group) GetVlanMembers() (resp []datatypes.Resource_Group_Member, err error) {
	err = invokeMethod("SoftLayer_Resource_Group", "getVlanMembers", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Group_Template) GetAllObjects() (resp []datatypes.Resource_Group_Template, err error) {
	err = invokeMethod("SoftLayer_Resource_Group_Template", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Resource_Group_Template) GetChildren() (resp []datatypes.Resource_Group_Template, err error) {
	err = invokeMethod("SoftLayer_Resource_Group_Template", "getChildren", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Resource_Group_Template) GetMembers() (resp []datatypes.Resource_Group_Template_Member, err error) {
	err = invokeMethod("SoftLayer_Resource_Group_Template", "getMembers", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Resource_Group_Template) GetObject() (resp datatypes.Resource_Group_Template, err error) {
	err = invokeMethod("SoftLayer_Resource_Group_Template", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Resource_Group_Template) GetPackage() (resp datatypes.Product_Package, err error) {
	err = invokeMethod("SoftLayer_Resource_Group_Template", "getPackage", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Metadata) GetBackendMacAddresses() (resp []string, err error) {
	err = invokeMethod("SoftLayer_Resource_Metadata", "getBackendMacAddresses", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Metadata) GetDatacenter() (resp string, err error) {
	err = invokeMethod("SoftLayer_Resource_Metadata", "getDatacenter", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Metadata) GetDatacenterId() (resp int, err error) {
	err = invokeMethod("SoftLayer_Resource_Metadata", "getDatacenterId", nil, r.Session, &r.Options, &resp)
	return
}

// The getDomain method retrieves the hostname for the resource.
func (r Resource_Metadata) GetDomain() (resp string, err error) {
	err = invokeMethod("SoftLayer_Resource_Metadata", "getDomain", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Metadata) GetFrontendMacAddresses() (resp []string, err error) {
	err = invokeMethod("SoftLayer_Resource_Metadata", "getFrontendMacAddresses", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Metadata) GetFullyQualifiedDomainName() (resp string, err error) {
	err = invokeMethod("SoftLayer_Resource_Metadata", "getFullyQualifiedDomainName", nil, r.Session, &r.Options, &resp)
	return
}

// The getHostname method retrieves the hostname for the resource.
func (r Resource_Metadata) GetHostname() (resp string, err error) {
	err = invokeMethod("SoftLayer_Resource_Metadata", "getHostname", nil, r.Session, &r.Options, &resp)
	return
}

// The getId method retrieves the ID for the resource
func (r Resource_Metadata) GetId() (resp int, err error) {
	err = invokeMethod("SoftLayer_Resource_Metadata", "getId", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Metadata) GetPrimaryBackendIpAddress() (resp string, err error) {
	err = invokeMethod("SoftLayer_Resource_Metadata", "getPrimaryBackendIpAddress", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Metadata) GetPrimaryIpAddress() (resp string, err error) {
	err = invokeMethod("SoftLayer_Resource_Metadata", "getPrimaryIpAddress", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Metadata) GetProvisionState() (resp string, err error) {
	err = invokeMethod("SoftLayer_Resource_Metadata", "getProvisionState", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Metadata) GetRouter(macAddress *string) (resp string, err error) {
	...
	err = invokeMethod("SoftLayer_Resource_Metadata", "getRouter", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Metadata) GetServiceResource(serviceName *string, index *int) (resp string, err error) {
	...
	err = invokeMethod("SoftLayer_Resource_Metadata", "getServiceResource", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Metadata) GetServiceResources() (resp []datatypes.Container_Resource_Metadata_ServiceResource, err error) {
	err = invokeMethod("SoftLayer_Resource_Metadata", "getServiceResources", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Metadata) GetTags() (resp []string, err error) {
	err = invokeMethod("SoftLayer_Resource_Metadata", "getTags", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Metadata) GetUserMetadata() (resp string, err error) {
	err = invokeMethod("SoftLayer_Resource_Metadata", "getUserMetadata", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Metadata) GetVlanIds(macAddress *string) (resp []int, err error) {
	...
	err = invokeMethod("SoftLayer_Resource_Metadata", "getVlanIds", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Resource_Metadata) GetVlans(macAddress *string) (resp []int, err error) {
	...
	err = invokeMethod("SoftLayer_Resource_Metadata", "getVlans", params, r.Session, &r.Options, &resp)
	return
}
