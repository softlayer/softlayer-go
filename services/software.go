...
func (r Software_AccountLicense) GetAccount() (resp datatypes.Account, err error) {
	err = invokeMethod("SoftLayer_Software_AccountLicense", "getAccount", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Software_AccountLicense) GetAllObjects() (resp []datatypes.Software_AccountLicense, err error) {
	err = invokeMethod("SoftLayer_Software_AccountLicense", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_AccountLicense) GetBillingItem() (resp datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Software_AccountLicense", "getBillingItem", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Software_AccountLicense) GetObject() (resp datatypes.Software_AccountLicense, err error) {
	err = invokeMethod("SoftLayer_Software_AccountLicense", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_AccountLicense) GetSoftwareDescription() (resp datatypes.Software_Description, err error) {
	err = invokeMethod("SoftLayer_Software_AccountLicense", "getSoftwareDescription", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component) GetAverageInstallationDuration() (resp uint, err error) {
	err = invokeMethod("SoftLayer_Software_Component", "getAverageInstallationDuration", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component) GetBillingItem() (resp datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Software_Component", "getBillingItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component) GetHardware() (resp datatypes.Hardware, err error) {
	err = invokeMethod("SoftLayer_Software_Component", "getHardware", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component) GetLicenseFile() (resp string, err error) {
	err = invokeMethod("SoftLayer_Software_Component", "getLicenseFile", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component) GetObject() (resp datatypes.Software_Component, err error) {
	err = invokeMethod("SoftLayer_Software_Component", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component) GetPasswordHistory() (resp []datatypes.Software_Component_Password_History, err error) {
	err = invokeMethod("SoftLayer_Software_Component", "getPasswordHistory", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component) GetPasswords() (resp []datatypes.Software_Component_Password, err error) {
	err = invokeMethod("SoftLayer_Software_Component", "getPasswords", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component) GetSoftwareDescription() (resp datatypes.Software_Description, err error) {
	err = invokeMethod("SoftLayer_Software_Component", "getSoftwareDescription", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component) GetSoftwareLicense() (resp datatypes.Software_License, err error) {
	err = invokeMethod("SoftLayer_Software_Component", "getSoftwareLicense", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Software_Component) GetVendorSetUpConfiguration() (resp string, err error) {
	err = invokeMethod("SoftLayer_Software_Component", "getVendorSetUpConfiguration", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component) GetVirtualGuest() (resp datatypes.Virtual_Guest, err error) {
	err = invokeMethod("SoftLayer_Software_Component", "getVirtualGuest", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component_AntivirusSpyware) GetAverageInstallationDuration() (resp uint, err error) {
	err = invokeMethod("SoftLayer_Software_Component_AntivirusSpyware", "getAverageInstallationDuration", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The billing item for a software component.
func (r Software_Component_AntivirusSpyware) GetBillingItem() (resp datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Software_Component_AntivirusSpyware", "getBillingItem", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The hardware this Software Component is installed upon.
func (r Software_Component_AntivirusSpyware) GetHardware() (resp datatypes.Hardware, err error) {
	err = invokeMethod("SoftLayer_Software_Component_AntivirusSpyware", "getHardware", nil, r.Session, &r.Options, &resp)
	return
}

// Attempt to retrieve the file associated with a software component.  If the software component does not support downloading license files an exception will be thrown.
func (r Software_Component_AntivirusSpyware) GetLicenseFile() (resp string, err error) {
	err = invokeMethod("SoftLayer_Software_Component_AntivirusSpyware", "getLicenseFile", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Software_Component_AntivirusSpyware) GetObject() (resp datatypes.Software_Component_AntivirusSpyware, err error) {
	err = invokeMethod("SoftLayer_Software_Component_AntivirusSpyware", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component_AntivirusSpyware) GetPasswordHistory() (resp []datatypes.Software_Component_Password_History, err error) {
	err = invokeMethod("SoftLayer_Software_Component_AntivirusSpyware", "getPasswordHistory", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve Username/Password pairs used for access to this Software Installation.
func (r Software_Component_AntivirusSpyware) GetPasswords() (resp []datatypes.Software_Component_Password, err error) {
	err = invokeMethod("SoftLayer_Software_Component_AntivirusSpyware", "getPasswords", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The Software Description of this Software Component.
func (r Software_Component_AntivirusSpyware) GetSoftwareDescription() (resp datatypes.Software_Description, err error) {
	err = invokeMethod("SoftLayer_Software_Component_AntivirusSpyware", "getSoftwareDescription", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The License this Software Component uses.
func (r Software_Component_AntivirusSpyware) GetSoftwareLicense() (resp datatypes.Software_License, err error) {
	err = invokeMethod("SoftLayer_Software_Component_AntivirusSpyware", "getSoftwareLicense", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Software_Component_AntivirusSpyware) GetVendorSetUpConfiguration() (resp string, err error) {
	err = invokeMethod("SoftLayer_Software_Component_AntivirusSpyware", "getVendorSetUpConfiguration", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The virtual guest this software component is installed upon.
func (r Software_Component_AntivirusSpyware) GetVirtualGuest() (resp datatypes.Virtual_Guest, err error) {
	err = invokeMethod("SoftLayer_Software_Component_AntivirusSpyware", "getVirtualGuest", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component_AntivirusSpyware) UpdateAntivirusSpywarePolicy(newPolicy *string, enforce *bool) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Software_Component_AntivirusSpyware", "updateAntivirusSpywarePolicy", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component_HostIps) GetAverageInstallationDuration() (resp uint, err error) {
	err = invokeMethod("SoftLayer_Software_Component_HostIps", "getAverageInstallationDuration", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The billing item for a software component.
func (r Software_Component_HostIps) GetBillingItem() (resp datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Software_Component_HostIps", "getBillingItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component_HostIps) GetCurrentHostIpsPolicies() (resp []datatypes.Container_Software_Component_HostIps_Policy, err error) {
	err = invokeMethod("SoftLayer_Software_Component_HostIps", "getCurrentHostIpsPolicies", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The hardware this Software Component is installed upon.
func (r Software_Component_HostIps) GetHardware() (resp datatypes.Hardware, err error) {
	err = invokeMethod("SoftLayer_Software_Component_HostIps", "getHardware", nil, r.Session, &r.Options, &resp)
	return
}

// Attempt to retrieve the file associated with a software component.  If the software component does not support downloading license files an exception will be thrown.
func (r Software_Component_HostIps) GetLicenseFile() (resp string, err error) {
	err = invokeMethod("SoftLayer_Software_Component_HostIps", "getLicenseFile", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Software_Component_HostIps) GetObject() (resp datatypes.Software_Component_HostIps, err error) {
	err = invokeMethod("SoftLayer_Software_Component_HostIps", "getObject", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve History Records for Software Passwords.
func (r Software_Component_HostIps) GetPasswordHistory() (resp []datatypes.Software_Component_Password_History, err error) {
	err = invokeMethod("SoftLayer_Software_Component_HostIps", "getPasswordHistory", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve Username/Password pairs used for access to this Software Installation.
func (r Software_Component_HostIps) GetPasswords() (resp []datatypes.Software_Component_Password, err error) {
	err = invokeMethod("SoftLayer_Software_Component_HostIps", "getPasswords", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The Software Description of this Software Component.
func (r Software_Component_HostIps) GetSoftwareDescription() (resp datatypes.Software_Description, err error) {
	err = invokeMethod("SoftLayer_Software_Component_HostIps", "getSoftwareDescription", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The License this Software Component uses.
func (r Software_Component_HostIps) GetSoftwareLicense() (resp datatypes.Software_License, err error) {
	err = invokeMethod("SoftLayer_Software_Component_HostIps", "getSoftwareLicense", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Software_Component_HostIps) GetVendorSetUpConfiguration() (resp string, err error) {
	err = invokeMethod("SoftLayer_Software_Component_HostIps", "getVendorSetUpConfiguration", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve The virtual guest this software component is installed upon.
func (r Software_Component_HostIps) GetVirtualGuest() (resp datatypes.Virtual_Guest, err error) {
	err = invokeMethod("SoftLayer_Software_Component_HostIps", "getVirtualGuest", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component_HostIps) UpdateHipsPolicies(newIpsMode *string, newIpsProtection *string, newFirewallMode *string, newFirewallRuleset *string, newApplicationMode *string, newApplicationRuleset *string, newEnforcementPolicy *string) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Software_Component_HostIps", "updateHipsPolicies", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component_Password) CreateObject(templateObject *datatypes.Software_Component_Password) (resp datatypes.Software_Component_Password, err error) {
	...
	err = invokeMethod("SoftLayer_Software_Component_Password", "createObject", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component_Password) CreateObjects(templateObjects []datatypes.Software_Component_Password) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Software_Component_Password", "createObjects", params, r.Session, &r.Options, &resp)
	return
}

// Delete a password from a software component.
func (r Software_Component_Password) DeleteObject() (resp bool, err error) {
	err = invokeMethod("SoftLayer_Software_Component_Password", "deleteObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component_Password) DeleteObjects(templateObjects []datatypes.Software_Component_Password) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Software_Component_Password", "deleteObjects", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component_Password) EditObject(templateObject *datatypes.Software_Component_Password) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Software_Component_Password", "editObject", params, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component_Password) EditObjects(templateObjects []datatypes.Software_Component_Password) (resp bool, err error) {
	...
	err = invokeMethod("SoftLayer_Software_Component_Password", "editObjects", params, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Software_Component_Password) GetObject() (resp datatypes.Software_Component_Password, err error) {
	err = invokeMethod("SoftLayer_Software_Component_Password", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component_Password) GetSoftware() (resp datatypes.Software_Component, err error) {
	err = invokeMethod("SoftLayer_Software_Component_Password", "getSoftware", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Component_Password) GetSshKeys() (resp []datatypes.Security_Ssh_Key, err error) {
	err = invokeMethod("SoftLayer_Software_Component_Password", "getSshKeys", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Description) GetAllObjects() (resp []datatypes.Software_Description, err error) {
	err = invokeMethod("SoftLayer_Software_Description", "getAllObjects", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Software_Description) GetAttributes() (resp []datatypes.Software_Description_Attribute, err error) {
	err = invokeMethod("SoftLayer_Software_Description", "getAttributes", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Description) GetAverageInstallationDuration() (resp int, err error) {
	err = invokeMethod("SoftLayer_Software_Description", "getAverageInstallationDuration", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Description) GetCompatibleSoftwareDescriptions() (resp []datatypes.Software_Description, err error) {
	err = invokeMethod("SoftLayer_Software_Description", "getCompatibleSoftwareDescriptions", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Description) GetFeatures() (resp []datatypes.Software_Description_Feature, err error) {
	err = invokeMethod("SoftLayer_Software_Description", "getFeatures", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Description) GetLatestVersion() (resp []datatypes.Software_Description, err error) {
	err = invokeMethod("SoftLayer_Software_Description", "getLatestVersion", nil, r.Session, &r.Options, &resp)
	return
}

// no documentation yet
func (r Software_Description) GetObject() (resp datatypes.Software_Description, err error) {
	err = invokeMethod("SoftLayer_Software_Description", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Description) GetProductItems() (resp []datatypes.Product_Item, err error) {
	err = invokeMethod("SoftLayer_Software_Description", "getProductItems", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Description) GetProvisionTransactionGroup() (resp datatypes.Provisioning_Version1_Transaction_Group, err error) {
	err = invokeMethod("SoftLayer_Software_Description", "getProvisionTransactionGroup", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Description) GetReloadTransactionGroup() (resp datatypes.Provisioning_Version1_Transaction_Group, err error) {
	err = invokeMethod("SoftLayer_Software_Description", "getReloadTransactionGroup", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Description) GetRequiredUser() (resp string, err error) {
	err = invokeMethod("SoftLayer_Software_Description", "getRequiredUser", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Description) GetSoftwareLicenses() (resp []datatypes.Software_License, err error) {
	err = invokeMethod("SoftLayer_Software_Description", "getSoftwareLicenses", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Description) GetUpgradeSoftwareDescription() (resp datatypes.Software_Description, err error) {
	err = invokeMethod("SoftLayer_Software_Description", "getUpgradeSoftwareDescription", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_Description) GetUpgradeSwDesc() (resp datatypes.Software_Description, err error) {
	err = invokeMethod("SoftLayer_Software_Description", "getUpgradeSwDesc", nil, r.Session, &r.Options, &resp)
	return
}

// Retrieve
func (r Software_Description) GetValidFilesystemTypes() (resp []datatypes.Configuration_Storage_Filesystem_Type, err error) {
	err = invokeMethod("SoftLayer_Software_Description", "getValidFilesystemTypes", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_VirtualLicense) GetAccount() (resp datatypes.Account, err error) {
	err = invokeMethod("SoftLayer_Software_VirtualLicense", "getAccount", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_VirtualLicense) GetBillingItem() (resp datatypes.Billing_Item, err error) {
	err = invokeMethod("SoftLayer_Software_VirtualLicense", "getBillingItem", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_VirtualLicense) GetHostHardware() (resp datatypes.Hardware_Server, err error) {
	err = invokeMethod("SoftLayer_Software_VirtualLicense", "getHostHardware", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_VirtualLicense) GetIpAddressRecord() (resp datatypes.Network_Subnet_IpAddress, err error) {
	err = invokeMethod("SoftLayer_Software_VirtualLicense", "getIpAddressRecord", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_VirtualLicense) GetLicenseFile() (resp []byte, err error) {
	err = invokeMethod("SoftLayer_Software_VirtualLicense", "getLicenseFile", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_VirtualLicense) GetObject() (resp datatypes.Software_VirtualLicense, err error) {
	err = invokeMethod("SoftLayer_Software_VirtualLicense", "getObject", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_VirtualLicense) GetSoftwareDescription() (resp datatypes.Software_Description, err error) {
	err = invokeMethod("SoftLayer_Software_VirtualLicense", "getSoftwareDescription", nil, r.Session, &r.Options, &resp)
	return
}
...
func (r Software_VirtualLicense) GetSubnet() (resp datatypes.Network_Subnet, err error) {
	err = invokeMethod("SoftLayer_Software_VirtualLicense", "getSubnet", nil, r.Session, &r.Options, &resp)
	return
}
